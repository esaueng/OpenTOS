...
export function geometrySurfaceArea(geometry) {
...
export function computeOutcomeMetrics(args) {
    ...
    const materialProps = MATERIAL_PROPERTIES[args.material] ?? MATERIAL_PROPERTIES["Aluminum 6061"];
    ...
    const displacementProxy = (totalForce * Math.max(args.characteristicLength * unitScale, 1e-6)) /
